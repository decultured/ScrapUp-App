package ScrapUp.Scrap
{
	...
	public class Scrap implements IResizeable, IMoveable
	{
		[Savable]public var UID:String;
		
		[Bindable][Savable] public var type:String = "unknown:define_in_scrap_constructor";
		...
		private var _ScrapEditorSkin:Class = null;
		private var _SmallScrapEditorSkin:Class = null;
		...
		public var view:ScrapView;
		
		public function Scrap(_scrapViewSkin:Class, _scrapEditorSkin:Class, _smallScrapEditorSkin:Class = null):void
		{
			if (_scrapViewSkin)
				view = new ScrapView(this, _scrapViewSkin);
			UID = UIDUtil.createUID();
			_ScrapEditorSkin = _scrapEditorSkin;
			_SmallScrapEditorSkin = _smallScrapEditorSkin;
		...
		public function CreateEditor():ScrapEditor
		{
			return new ScrapEditor(this, _ScrapEditorSkin);
		}
		
		public function CreateSmallEditor():ScrapEditor
		{
			if (_SmallScrapEditorSkin)
				return new ScrapEditor(this, _SmallScrapEditorSkin);
			else
				return null;
		}
		...
		{
			Logger.LogWarning("Scrap Cannot Refresh", this);
		}
